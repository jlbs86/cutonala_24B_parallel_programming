...
class point2point_communication:    
    def pickle_underdahood():
        comm = MPI.COMM_WORLD
        rank = comm.Get_rank()
    ...
    def arrays():
        ...
        if rank == 0:
            ...
            print(f"Proceso {rank} recibio un array de enteros: {data[:10]}...")
        ...
        if rank == 0:
            ...
            print(f"Proceso {rank} recibio un array de flotantes: {data[:10]}...")
...
class collective_communication:
    ...
    def broadcasting_array():
        ...
        print(f"Proceso {rank} recibio el array: {data[:10]}...")
        for i in range(100):
            assert data[i] == i
    ...
    def scattering_numpy_arrays():
        ...
        print(f"Proceso {rank} recibio el array: {recvbuf[:10]}...")
    ...
    def gathering_numpy_arrays():
        ...
        if rank == 0:
            print(f"Proceso {rank} recibio el array combinado: {recvbuf[:, :10]}...")
            for i in range(size):
...
if __name__ == "__main__":
    ...
    point2point_communication.pickle_underdahood()

    if rank == 0:
        print("\nPoint-to-Point Communication - Non-blocking Example:")
    point2point_communication.non_blocking()

    if rank == 0:
        print("\nPoint-to-Point Communication - Arrays Example:")
    point2point_communication.arrays()


    if rank == 0:
        print("Collective Comunication - Broadcasting Example:")
    collective_communication.broadcasting()

    if rank == 0:
        print("\nCollective Comunication - Scattering Example:")
    collective_communication.scattering()

    if rank == 0:
        print("\nCollective Comunication - Gathering Example:")
    collective_communication.gathering()

    if rank == 0:
        print("\nCollective Comunication - Broadcasting Array Example:")
    collective_communication.broadcasting_array()

    if rank == 0:
        print("\nCollective Comunication - Scattering NumPy Arrays Example:")
    collective_communication.scattering_numpy_arrays()

    if rank == 0:
        print("\nCollective Comunication - Gathering NumPy Arrays Example:")
