...
# Scattering de los puntos a todos los procesos
local_points = comm.scatter(points_split, root=0)
...
if rank == 0:
    ...
    plt.savefig('/content/delaunay_triangulation__collective_communication_scattering.png')  # Guardar la gráfica
